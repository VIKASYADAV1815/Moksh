    ...
    <section className="py-24 sm:py-32 bg-white relative z-20">
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2 bg-white border border-slate-200/45 rounded-3xl p-8 shadow-sm overflow-hidden relative">
            ...
            <p className="text-slate-600 text-sm mb-10 max-w-md font-medium">
              Plan and organize multi-channel campaigns with clear timelines, budgets, and performance milestones.
            </p>
            
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 w-full relative h-48 mt-4 overflow-hidden">
              <div className="text-xs font-bold text-slate-500 mb-4">Timeline</div>
              <div className="flex justify-between text-[10px] text-slate-500 font-medium border-b border-slate-200 pb-2 mb-4">
              ...
              <div className="relative h-24">
                <motion.div 
                  className="absolute left-8 top-0 bg-slate-900 text-white text-xs font-medium px-3 py-1.5 rounded-full flex items-center gap-2 cursor-pointer"
                ...
                <motion.div 
                  className="absolute left-48 top-0 bg-white border border-slate-300 text-slate-800 shadow-sm text-xs font-medium px-3 py-1.5 rounded-full flex items-center gap-2 cursor-pointer"
                  whileHover={{ x: -10, scale: 1.02 }}
                >
                  <svg className="w-3 h-3 text-slate-500" viewBox="0 0 24 24" fill="currentColor"><path d="M3 3h18v18H3V3zm16 16V5H5v14h14zM7 7h10v2H7V7zm0 4h10v2H7v-2zm0 4h7v2H7v-2z"/></svg>
                  SEO Campaign
                </motion.div>
                <motion.div 
                  className="absolute left-32 top-10 bg-white border border-slate-300 text-slate-800 shadow-sm text-xs font-medium px-3 py-1.5 rounded-full flex items-center gap-2 cursor-pointer"
